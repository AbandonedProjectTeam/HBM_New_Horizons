...
import com.hbmkotlin.interfaces.Spaghetti;
import net.minecraft.util.Identifier;
import net.fabricmc.api.EnvType;
import net.fabricmc.api.Platform;
import net.fabricmc.api.ClientModInitializer;
import net.fabricmc.api.ModInitializer;

public class Tuple {

    // Для демонстрации: пример модификации аннотации с использованием Fabric.
    // Если вам не нужно интегрировать аннотацию `@Spaghetti`, вы можете удалить её.
    @Spaghetti("already??")
